...
1.  [primeira semana](#orgab9731b)
    1.  [o que é machine learning?](#org8cb3bf8)
        1.  [leitura](#org9473190)
    2.  [tipos de algoritmos](#org87b818f)
    3.  [supervised learning](#org3539cc0)
        1.  [leitura](#org1f430c2)
        2.  [regression problem](#org60b4832)
        3.  [classification problem](#org6c95fa7)
    4.  [unsupervised learning](#org45f69ec)
        1.  [leitura](#org709c5f4)
    5.  [regressão linear](#org5594440)
        1.  [model and cost function](#orgcb73430)
        2.  [cost function](#orgea72a62)
        3.  [cost function intuition I](#orgb5b8f5f)
        4.  [cost function intuition II](#orgd9230be)
    6.  [parameter learning](#org4999b6a)
        1.  [gradient descent](#org87b4d4d)
        2.  [gradient descent intuition](#orgee6f313)
        3.  [gradiente descent for linear regression](#orgba63c11)
    7.  [linear algebra review](#orgc1a77d3)
        1.  [matrices and vectors](#org204ebf7)
        2.  [addition and scalar multiplication](#org37fd04f)
        3.  [matrix and vector multiplication](#orge246d7f)
        4.  [matrix matrix multiplication](#orgbc3b9eb)
        5.  [matrix multiplication properties](#org506bed2)
        6.  [inverse and transpose](#org6d473ae)
2.  [segunda semana](#org2baefaa)
    1.  [multivariate linear regression](#org9ca0573)
        1.  [multiple features](#org6d18153)
        2.  [gradient descent for multiple variables](#org68b3998)
        3.  [gradient descent in practice I - feature scaling](#org5c19899)
        4.  [gradient descent in practice II - learning rate](#org81a7094)
        5.  [features and polynomial regression](#orgc1449d5)
    2.  [computing parameters analytically](#orgcdd3bd6)
        1.  [normal equation](#org02b6171)
        2.  [normal equation noninvertibility](#org072ea22)
    3.  [programming tips from mentors](#org3e4e7fc)
3.  [terceira semana](#org3fcc1d1)
    1.  [classification and representation](#org0302199)
        1.  [classification](#org67bb6ca)
        2.  [hypothesis representation](#org8c3c4e9)
        3.  [decision boundary](#org59bbe1e)
    2.  [logistic regression model](#orgd8640d1)
        1.  [cost function](#orgd6b22bf)
        2.  [simplified cost function and gradient descent](#org30789ed)
        3.  [advanced optimization](#org08f90f5)
    3.  [multiclass classification: one-vs-all](#org93237b2)
    4.  [solving the problem of overfitting](#orge61ce99)
        1.  [the problem of overfitting](#org35fff82)
        2.  [cost function](#orgf773155)
        3.  [regularized linear regression](#org230390a)
        4.  [regularized logistic regression](#orge16faa4)
4.  [quarta semana](#orgf219b96)
    1.  [neural networks](#orgcd6c789)
        1.  [model representation I](#org7db9fba)
        2.  [model representation II](#orgf804251)
    2.  [applications](#org2c3ed00)
        1.  [examples and intuitions I](#org6da3fcb)
        2.  [examples and intuitions II](#orgd74a654)
        3.  [multiclass classification](#org190460d)
5.  [quinta semana](#org9379f8e)
    1.  [cost function and backpropagation](#org0622876)
        1.  [cost function](#org098fd50)
        2.  [backpropagation algorithm](#orgc02ce45)
        3.  [backpropagation intuition](#org04476d8)
    2.  [backpropagation in practice](#orga084e30)
        1.  [implementation note: unrolling parameters](#org6fbf9f5)
        2.  [gradient checking](#orga99ce2b)
        3.  [random initialization](#orgf9f35d2)
        4.  [putting it together](#orgfc65c87)
6.  [sexta semana](#org48b0d9d)
    1.  [evaluating a learning algorithm](#org9b3dfab)
        1.  [evaluating a hypothesis](#orgf8305e2)
        2.  [model selection and train/validation/test sets](#orga3bde6a)
    2.  [bias vs variance](#org5ffe16c)
        1.  [diagnosing bias vs variance](#org2fa950e)
        2.  [regulatization and bias/variance](#org5fc38d0)
        3.  [learning curves](#org99bb31f)
        4.  [deciding what to do next revisited](#orgc0d2168)
    3.  [building a spam classifier](#org3ac31f1)
        1.  [prioritizing what to work on](#org11e327b)
        2.  [error analysis](#org425d3cc)
7.  [sétima semana](#org2e548d4)
    1.  [optimization objective](#orgc95e4ff)
    2.  [large margin intuition](#orgf0a9e06)
    3.  [Mathematics Behind Large Margin Classification (Optional)](#org986f075)
    4.  [kernels I](#orgba31375)
    5.  [kernels II](#org391a556)
    6.  [choosing SVM parameters](#org3d467aa)
    7.  [Using An SVM](#orgc06bac9)
    8.  [multi-class classification](#org75f0afc)
    9.  [logistic regression vs. SVMs](#orgcf49c54)
8.  [oitava semana](#org1bf17d9)
    1.  [ML:Clustering](#org7ace74b)
        1.  [Unsupervised Learning: Introduction](#org004f4c7)
        2.  [k-means algorithm](#org4209a0c)
        3.  [optimization objective](#orgb287517)
        4.  [random initialization](#orge3bad9e)
        5.  [choosing the number of clusters](#orga852f58)
        6.  [bonus: discussion of the drawbacks of k-means](#orgb786eb2)
    2.  [ML:Dimensionality Reduction](#orga0fb433)
        1.  [principal component analysis problem formulation](#orgb41f9a3)
        2.  [principal component analysis algorithm](#org83ee585)
        3.  [reconstruction from compressed representation](#orgaf12d03)
        4.  [choosing the number of principal components](#orgddc7c36)
        5.  [advice for applying PCA](#orgc92d732)
9.  [nona semana](#orged6a76c)
    1.  [ML:Anomaly detection](#org4bc64f8)
        1.  [problem motivation](#org56f093f)
        2.  [gaussian distribution](#org99f3f5a)
        3.  [algorithm](#orgc0f4897)
        4.  [Developing and Evaluating an Anomaly Detection System](#orga5873ef)
        5.  [anomaly detection vs. supervised learning](#orgc46623c)
        6.  [choosing what features to use](#org39d4fb7)
        7.  [Multivariate Gaussian Distribution (Optional)](#org09cc12f)
        8.  [Anomaly Detection using the Multivariate Gaussian Distribution (Optional)](#org9f2a9d4)
    2.  [ML: Recommender Systems](#org125bec8)
        1.  [problem formulation](#orga912aed)
        2.  [content based recommendations](#orged6ba36)
        3.  [collaborative filtering algorithm](#orge47fa8a)
        4.  [vectorization: low rank matrix factorization](#org8eb9303)
        5.  [implementation detail: mean normalization](#org00e99a1)
10. [décima semana](#org63dbd67)
    1.  [learning with large datasets](#org2a086bd)
    2.  [stochastic gradient descent](#org401f6b2)
    3.  [mini-batch gradient descent](#org4a3dfc3)
    4.  [stochastic gradient descent convergence](#org6ada001)
    5.  [online learning](#org05489ec)
    6.  [map reduce and data parallelism](#org0a0744a)
...
1.  leitura
    ...
    \frac{1}{2m}\sum^{m}_{i=1} (h_\thetha(x_i)-y_i)^2\]
...
<tbody>
<tr>
<td class="org-left">Needs to choose alpha</td>
<td class="org-left">No need to choose alpha</td>
</tr>


<tr>
<td class="org-left">Needs many iterations</td>
<td class="org-left">No need to iterate</td>
</tr>


<tr>
<td class="org-left">O(kn<sup>2</sup>)</td>
<td class="org-left">O(n<sup>3</sup>), need to calculate the inverse of X<sup>T</sup> X</td>
</tr>


<tr>
<td class="org-left">Works well when n is large</td>
<td class="org-left">Slow if n is ery large</td>
</tr>
</tbody>
</table>
...
Cost(hθ(x),y) = −y.log(h<sub>θ</sub>(x))−(1−y)log(1−h<sub>θ</sub>(x)) 

Notice that when y is equal to 1, then the second term
(1-y)log(1-h<sub>&theta;</sub>(x)) will be zero and will not affect the result. If
y is equal to 0, then the first term −ylog(h<sub>θ</sub>(x)) will be zero and
...
parameter matrix Θ(2) containing the weights for our second layer of
nodes.
...
Θ<sup>(j)</sup> will be of dimension s<sup>j+1</sup>×(s<sub>j</sub>+1).  The +1 comes from the addition
in Θ(j) of the "bias nodes," x<sub>0</sub> and Θ<sup>(j)</sup><sub>0</sub>. In other words the
...
formula in the previous section and flag an anomaly if p(x) < ϵ.

The original model for p(x) corresponds to a multivariate Gaussian
where the contours of p(x;μ,Σ) are axis-aligned.
...
greater than the number of features for Σ to be invertible).
...
One approach is that we could do linear regression for every single
  user. For each user j, learn a parameter θ<sup>(j)</sup>∈R<sup>3</sup>. Predict user j as
...
1.  Initialize x<sup>(i)</sup>,&#x2026;,x<sup>(n<sub>m</sub>)</sup>,&theta;<sup>(1)</sup>,&#x2026;,&theta;<sup>(n<sub>u</sub>)</sup> to small
    random values. This serves to break symmetry and ensures that the
    algorithm learns features x<sup>(i)</sup>,&#x2026;,x<sup>(n<sub>m</sub>)</sup> that are different from
    each other.
...
by all users is given simply by: Y=XΘ<sup>T</sup>.
...
are looking for a small value of ||x<sup>(i)</sup> - x<sup>(j)</sup>||.
...
Θ<sub>j</sub> := Θ<sub>j</sub> − α(h<sub>Θ</sub>(x<sup>(i)</sup>)−y<sup>(i)</sup>)⋅x<sup>(i)</sup><sub>j</sub>
...
Θ<sub>j</sub> := Θ<sub>j</sub> − (α/z)(temp<sup>(1)</sup><sub>j</sub>+temp<sup>(2)</sup><sub>j</sub>+⋯+temp<sup>(z)</sup><sub>j</sub>)
For all j = 0, &hellip;, nj=0,…,n.

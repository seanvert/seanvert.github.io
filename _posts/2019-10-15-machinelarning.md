...
1.  [primeira semana](#orgb219955)
    1.  [o que é machine learning?](#org3f09ea9)
        1.  [leitura](#org6e598c3)
    2.  [tipos de algoritmos](#org44caf07)
    3.  [supervised learning](#org1e40721)
        1.  [leitura](#org857b5cf)
        2.  [regression problem](#org26c6284)
        3.  [classification problem](#org9fbc253)
    4.  [unsupervised learning](#orge221f41)
        1.  [leitura](#orgfc9580a)
    5.  [regressão linear](#orga1634f8)
        1.  [model and cost function](#orgfcfd783)
        2.  [cost function](#org8ae8268)
        3.  [cost function intuition I](#orgb94db47)
        4.  [cost function intuition II](#orgcc42bef)
    6.  [parameter learning](#orgea140fa)
        1.  [gradient descent](#org3d29a3e)
        2.  [gradient descent intuition](#orgbd82072)
        3.  [gradiente descent for linear regression](#org0c5369f)
    7.  [linear algebra review](#org3c16ac1)
        1.  [matrices and vectors](#org05fcf64)
        2.  [addition and scalar multiplication](#org4128045)
        3.  [matrix and vector multiplication](#org3000c15)
        4.  [matrix matrix multiplication](#orga501d07)
        5.  [matrix multiplication properties](#org879c9f9)
        6.  [inverse and transpose](#org932c89a)
2.  [segunda semana](#org28c616f)
    1.  [multivariate linear regression](#org4d4f507)
        1.  [multiple features](#org3b01ed5)
        2.  [gradient descent for multiple variables](#org931deb0)
        3.  [gradient descent in practice I - feature scaling](#orgb0e3f3d)
        4.  [gradient descent in practice II - learning rate](#org812a258)
        5.  [features and polynomial regression](#orgcd4f107)
    2.  [computing parameters analytically](#orgf3080e2)
        1.  [normal equation](#org9ceceb3)
        2.  [normal equation noninvertibility](#orga94cf62)
    3.  [programming tips from mentors](#org2fd0b1b)
3.  [terceira semana](#orgbef8722)
    1.  [classification and representation](#orga6583b0)
        1.  [classification](#org2c7b060)
        2.  [hypothesis representation](#org6129ebd)
        3.  [decision boundary](#orgaa7bcc4)
    2.  [logistic regression model](#orgadecb07)
        1.  [cost function](#org86e9dbd)
        2.  [simplified cost function and gradient descent](#org4d993d4)
        3.  [advanced optimization](#orgf9adf04)
    3.  [multiclass classification: one-vs-all](#org5dbe781)
    4.  [solving the problem of overfitting](#orgee72dee)
        1.  [the problem of overfitting](#org4265d1f)
        2.  [cost function](#orgd5de1be)
        3.  [regularized linear regression](#org177d416)
        4.  [regularized logistic regression](#orgacfa903)
4.  [quarta semana](#orgdc47b77)
    1.  [neural networks](#orgd6af3f7)
        1.  [model representation I](#orge8cde4f)
        2.  [model representation II](#org1876e84)
    2.  [applications](#orgba3a6fa)
        1.  [examples and intuitions I](#org522d3f2)
        2.  [examples and intuitions II](#org2e976b4)
        3.  [multiclass classification](#orgc4fca4d)
5.  [quinta semana](#org39eb486)
    1.  [cost function and backpropagation](#orgf941a60)
        1.  [cost function](#orgaa8954c)
        2.  [backpropagation algorithm](#orgda9f541)
        3.  [backpropagation intuition](#org3a2c682)
    2.  [backpropagation in practice](#org5b68de3)
        1.  [implementation note: unrolling parameters](#org9cb365a)
        2.  [gradient checking](#org9abc503)
        3.  [random initialization](#org2336ec3)
        4.  [putting it together](#org25f4af0)
6.  [sexta semana](#org9bf274c)
    1.  [evaluating a learning algorithm](#orgd5da446)
        1.  [evaluating a hypothesis](#org291183a)
        2.  [model selection and train/validation/test sets](#org30658b3)
    2.  [bias vs variance](#orgec9dfc2)
        1.  [diagnosing bias vs variance](#orgc511589)
        2.  [regulatization and bias/variance](#orgb78cadd)
        3.  [learning curves](#org83bfd02)
        4.  [deciding what to do next revisited](#org0b67b9c)
    3.  [building a spam classifier](#org7b9bb7b)
        1.  [prioritizing what to work on](#org48d9440)
        2.  [error analysis](#org80e0d75)
7.  [sétima semana](#org7b5cdff)
    1.  [optimization objective](#org9c93138)
    2.  [large margin intuition](#org24e9a11)
    3.  [Mathematics Behind Large Margin Classification (Optional)](#org7889d71)
    4.  [kernels I](#orgeb0a72f)
    5.  [kernels II](#org6beb928)
    6.  [choosing SVM parameters](#orgae231fe)
    7.  [Using An SVM](#org40d7bea)
    8.  [multi-class classification](#org6bd67da)
    9.  [logistic regression vs. SVMs](#org3423d58)
8.  [oitava semana](#org92f5926)
    1.  [ML:Clustering](#org251f32a)
        1.  [Unsupervised Learning: Introduction](#org172b315)
        2.  [k-means algorithm](#org8493fd5)
        3.  [optimization objective](#orgfc8aa79)
        4.  [random initialization](#orgde29940)
        5.  [choosing the number of clusters](#org708bad0)
        6.  [bonus: discussion of the drawbacks of k-means](#org014a683)
    2.  [ML:Dimensionality Reduction](#org95959fd)
        1.  [principal component analysis problem formulation](#orgbd6aa3e)
        2.  [principal component analysis algorithm](#org45dc289)
        3.  [reconstruction from compressed representation](#orgc208618)
        4.  [choosing the number of principal components](#org253c8da)
        5.  [advice for applying PCA](#org0c750af)
9.  [nona semana](#orgfe857e2)
    1.  [ML:Anomaly detection](#orgdb6287c)
        1.  [problem motivation](#org10941de)
        2.  [gaussian distribution](#org8cfad72)
        3.  [algorithm](#org4715068)
        4.  [Developing and Evaluating an Anomaly Detection System](#orgbc8708e)
        5.  [anomaly detection vs. supervised learning](#org4e9b7b2)
        6.  [choosing what features to use](#org2811cf5)
        7.  [Multivariate Gaussian Distribution (Optional)](#org90e471b)
        8.  [Anomaly Detection using the Multivariate Gaussian Distribution (Optional)](#org06217bb)
    2.  [ML: Recommender Systems](#org96bae4f)
        1.  [problem formulation](#org05612b3)
        2.  [content based recommendations](#orgfd5c066)
        3.  [collaborative filtering algorithm](#org11b8129)
        4.  [vectorization: low rank matrix factorization](#org7ef2324)
        5.  [implementation detail: mean normalization](#org0cee9e4)
10. [décima semana](#org9f13e54)
    1.  [learning with large datasets](#org8e085cb)
    2.  [stochastic gradient descent](#org644c233)
    3.  [mini-batch gradient descent](#org65fe155)
    4.  [stochastic gradient descent convergence](#orgfec29f7)
    5.  [online learning](#org9c74920)
    6.  [map reduce and data parallelism](#org693cdad)
...
![img](/assets/images/sétima_semana/KKNB3HtlEeaNlA6zo4Pi2Q_135a50fd32c5eb6f4bd89b22c476c45f_Svm_hinge_negative_class_2019-09-01_08-30-56.png)
